...
public class PdfExportUtils {
	...
	public static byte[] buildWeeklyReport(Season season, Week selectedWeek, ApplicationProperty publicMessage) {
		...
		try {
			Font font_times_large = FontFactory.getFont(FontFactory.TIMES_ROMAN, 14);
			Font font_times_large_underline = FontFactory.getFont(FontFactory.TIMES_ROMAN, 14, Font.UNDERLINE);
			Font font_times_normal = FontFactory.getFont(FontFactory.TIMES_ROMAN, 12);
			Font font_times_normal_underline = FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, Font.UNDERLINE);
			Font font_times_normal_bold = FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, Font.BOLD);
			Font font_times_normal_bold_underline = FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, Font.BOLD | Font.UNDERLINE);
			Font font_times_small = FontFactory.getFont(FontFactory.TIMES_ROMAN, 10);
			Font font_times_small_underline = FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.UNDERLINE);
			Font font_times_small_bold = FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.BOLD);
			Font font_times_small_bold_underline = FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.BOLD | Font.UNDERLINE);
	...
	private static void addGolfOutingPage(Document document) {
		Font font_times_large = FontFactory.getFont(FontFactory.TIMES_ROMAN, 14);
		Font font_times_large_bold = FontFactory.getFont(FontFactory.TIMES_ROMAN, 14, Font.BOLD);
		Font font_times_small = FontFactory.getFont(FontFactory.TIMES_ROMAN, 10);
		Font font_times_small_bold = FontFactory.getFont(FontFactory.TIMES_ROMAN, 10, Font.BOLD);
