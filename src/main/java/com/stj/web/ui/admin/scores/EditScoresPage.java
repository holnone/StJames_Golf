...
import com.stj.web.wicket.renderer.SideRenderer;
...
public class EditScoresPage extends AdminBasePage {
	...
	private DropDownChoice<Side> buildSideDropDown(String id, String property) {
		DropDownChoice<Side> sideDropDown = new DropDownChoice<Side>(id, new PropertyModel<Side>(this, property), sideChoices, new SideRenderer());
	...
	private boolean saveMatchup(AjaxRequestTarget target) {
		...
		Method setMethod = ReflectionUtils.findMethod(TeamScore.class, "set"+ this.matchPropertyName);
