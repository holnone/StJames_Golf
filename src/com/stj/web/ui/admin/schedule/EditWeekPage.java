...
public class EditWeekPage extends AdminBasePage {
	...
	private Component buildDropDown(final String id, String property) {
		final DropDownChoice<Team> component = new DropDownChoice<Team>(id, new PropertyModel<Team>(this.week, property), choices, getTeamRenderer());
	...
	private IChoiceRenderer<Team> getTeamRenderer() {
		return new IChoiceRenderer<Team>() {
			private static final long serialVersionUID = 1L;
			...
			public String getIdValue(Team team, int index) {
