...
public class StJamesApplication extends AuthenticatedWebApplication implements ApplicationContextAware {
	...
	protected void init() {
		if (!isInitialized) {
			...
			mount(new MountedMapperWithoutPageComponentInfo("/scorecard", ScorecardBasePage.class));
			...
			mount(new MountedMapperWithoutPageComponentInfo("/admin/scorecard", ScorecardPage.class));
